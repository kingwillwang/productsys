...
function uploadimg()
{
pop("/productsys/js/uploadimg.jsp","上传图片",300,77)
}

function uploadimg2()
{
pop("/productsys/js/uploadimg2.jsp","上传图片",300,77)
}

function uploadimg3()
{
pop("/productsys/js/uploadimg3.jsp","上传图片",300,77)
}

function uploadimg4()
{
pop("/productsys/js/uploadimg4.jsp","上传图片",300,77)
}


function uploadimg5()
{
pop("/productsys/js/uploadimg5.jsp","上传图片",300,77)
}


function uploaddoc()
{
pop("/productsys/js/uploaddoc.jsp","docupload",300,77)
}
...
build:function(){
   ...
   var close='<img id="dialogBoxClose" title="关闭" src=/productsys/js/dialogclose.gif  />';
