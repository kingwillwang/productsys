...
%>
<body>
	<form  action="ckwpcrinfoxg.jsp?f=f&id=<%=mmm.get("id")%>&ynum=<%=mmm.get("tnum")%>"  name="f1" method="post"  onsubmit="return checkform()" >
            								...
            								<table width="100%" border="0" cellspacing="0" cellpadding="0">
              									<tr>
                									...
                									<td width="95%" class="STYLE1">
                										<span class="STYLE3">你当前的位置</span>：修改出库信息
                									</td>
              									</tr>
            								</table>
            							</td>
        						...
        						<table style="margin-top:3px" width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#C3E5FB" >
          							...
          							<tr>
            							...
            							<td width="83%" bgcolor="#FFFFFF" class="STYLE1">
            								<input type='text' size='20'  onblur='checkform()'  class=''   name='opdate'  id='opdate' onclick='WdatePicker();'/>
...
<script language='javascript'> 
	...
	nnumpchichange();  
 	...
 	function checkform(){  
		...
		if(pchiobj.value==""||pchiobj.value=="不限"){
		...
		if (Number(document.getElementById("tnum").value) > Number(document
				.getElementById("nnum").value)) {
