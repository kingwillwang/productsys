        					...
        					<table style="margin-top:3px" width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#C3E5FB" >
         		 				...
         		 				<tr>
            						...
            						<td width="83%" bgcolor="#FFFFFF" class="STYLE1">
										<input type='text'  onblur='checkform()' class='' id='uname' name='uname' size='20' />
								...
								<tr>
            						...
            						<td width="83%" bgcolor="#FFFFFF" class="STYLE1">
            							<input type='text'  onblur='checkform()' class='' id='upass' name='upass' size='20'/>
								...
								<tr>
            						...
            						<td width="83%" bgcolor="#FFFFFF" class="STYLE1">
            							<input type='text'  onblur='checkform()' class='' id='tname' name='tname' size='20' />
								...
								<tr>
            						...
            						<td width="83%" bgcolor="#FFFFFF" class="STYLE1">
            							<input type='text'  onblur='checkform()' class='' id='tel' name='tel' size='20' />
            							<label id='clabeltel' />
            						</td>
          						</tr>
								<tr>
            						...
            						<td width="83%" bgcolor="#FFFFFF" class="STYLE1">
            							<input type='text'  onblur='checkform()' class='' id='email' name='email' size='20' />
								...
								<tr>
            						...
            						<td width="83%" bgcolor="#FFFFFF" class="STYLE1">
            							<textarea  cols='45' rows='3'  style="margin-top: 1px;margin-bottom: 1px;"  class=''  name='addrs' ></textarea>
            						</td>
          						</tr>
								<%-- <tr>
            						<td width="17%" height="30" bgcolor="#FFFFFF">
            							<div align="center">
            								<span class="STYLE1">相片</span>
            							</div>
            						</td>
            						<td width="83%" bgcolor="#FFFFFF" class="STYLE1">
