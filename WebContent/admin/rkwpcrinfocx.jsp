							...
							<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#C3E5FB">
								<tr>
									<td colspan='13' height="40" bgcolor="#FFFFFF" align="left" class="STYLE1"> 
										<%
 										...
 										%>
 										&nbsp; 
 										 入库日期：<input type='text' class='' size='10' name='startopdate' onclick='WdatePicker();' /> 
								...
								<tr>
									...
									<%
										...
										String url = "rkwpcrinfocx.jsp?1=1&opdate=" + popdate + "&spname=" + pspname + "";
								...
								<tr>
									...
									<td height="30" valign="middle" bgcolor="#FFFFFF"
										...
										<a href="rkwpcrinfoxg.jsp?id=<%=map.get("id")%>">修改</a>
										&nbsp;|&nbsp;
										<a onclick="return confirm('确定要删除这条记录吗?')"
											href="rkwpcrinfocx.jsp?scid=<%=map.get("id")%>">删除</a>
									</td>
								</tr>
									<%}%>
							</table>
