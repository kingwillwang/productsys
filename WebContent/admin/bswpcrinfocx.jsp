...
<body>
<form  action="bswpcrinfocx.jsp"  name="f1" method="post">
            							...
            							<table width="100%" border="0" cellspacing="0" cellpadding="0">
              								<tr>
                								...
                								<td width="95%" class="STYLE1">
                									<span class="STYLE3">你当前的位置</span>：物品报损
                								</td>
              								</tr>
            							</table>
            						</td>
      				...
      				<tr>
        				...
        				<td>
        					<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#C3E5FB" >
         						<tr>
            						<td colspan=12 height="36" bgcolor="#FFFFFF" align="left" class="STYLE1">
            						<%
          						...
          						<tr>
										<td height="28"
											...
											bgcolor="#FFFFFF" align="center" class="STYLE1">报损日期</td>
										<td height="28"
											background="/productsys/admin/tab/images/bg.png"
										...
										<td height="28"
											background="/productsys/admin/tab/images/bg.png"
											bgcolor="#FFFFFF" align="center" class="STYLE1">报损数量</td>
										<td height="28"
											background="/productsys/admin/tab/images/bg.png"
											bgcolor="#FFFFFF" align="center" class="STYLE1">报损原因</td>
										<td height="28"
											background="/productsys/admin/tab/images/bg.png"
									...
									<%
										...
										sql += "  and (1!=1 ";
										sql += "  or  optype like'%报损%' ";
										sql += "  ) ";
										sql += " order by id desc ";
										String url = "bswpcrinfocx.jsp?1=1&opdate=" + popdate + "&spname=" + pspname + "";
									...
									<tr>
										...
										<td height="30" valign="middle" bgcolor="#FFFFFF"
											...
											href="bswpcrinfoxg.jsp?id=<%=map.get("id")%>">修改</a></td>
								</tr>
								<%}%>
        					</table>
        				</td>
    		...
    		<td height="35" background="/productsys/admin/tab/images/tab_19.gif">
    			<table width="100%" border="0" cellspacing="0" cellpadding="0">
      				<tr>
        				...
        				<td colspan=12 align="center" valign="middle"  class="STYLE1" >
        					${page.info}
        				</td>
        				<td width="16">
...
function update(no){ 
pop('bswpcrinfoxg.jsp?id='+no,'信息修改',550,'100%') 
}
function add(){ 
pop('bswpcrinfotj.jsp','信息添加',550,'100%') 
}
</script> 
</body>
</html>