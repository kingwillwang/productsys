...
<%
	...
	new CommDAO().insert(request, response, "bases", ext, true, false);
%>
<body>
<form  action="basestj.jsp?f=f&tglparentid=<%=tglparentid%>"  name="f1" method="post"  onsubmit="return checkform()" >
        				...
        				<td>
        					<table style="margin-top:3px" width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#C3E5FB" >
								...
								<tr>
            						...
            						<td width="83%" bgcolor="#FFFFFF" class="STYLE1">
            							<textarea  cols='35' rows='3'  style='margin-top: 1px;margin-bottom: 1px' class=''  name='baddrs'></textarea>
            						</td>
          						</tr>
            					<tr>
...
function checkform(){  
	...
	if(bnameobj.value!=""){  
		var ajax = new AJAX();
		ajax.post("/productsys/factory/checkno.jsp?table=bases&col=bname&value="+bnameobj.value+"&checktype=insert&ttime=<%=Info.getDateStr()%>")
